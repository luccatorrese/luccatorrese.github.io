...
<body>
	...
	<div class="homework-text">
		...
		<dialog id="edit-work">
			<p>Modifier les informations du devoir sélectionné.</p>
		...
		<button type="button" id="add-button">Ajouter un devoir</button>
		<button type="button" id="change-button">Modifier un devoir</button>
		<button type="button" id="delete-button">Supprimer un devoir</button>
	</div>
